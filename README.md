...
It may change who can exercise authority, who can remove or supervise an officer, where a claim can be heard, what evidence remains available, and what remedy can follow.
...
Its workmanship is often strongest where a constitutional problem can be resolved through a clear institutional reassignment: superior executive review, removal authority, an Article III forum, a jury, or a defined process.

Its workmanship becomes thinner where the reset must also preserve evidence, retrospective remedy, legal memory, public record, and a workable route for the person already governed by the change.

Presidential immunity is the principal failure site.
...
It then compares successful constitutional repairs with the more difficult routes created by presidential immunity and removal remedy.

The standard is not whether every affected person wins.
